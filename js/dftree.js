 ...
 */
dNode.prototype._close = function() {
	if (this._io)
	{
 ...
 * @private
 */
dFTree.prototype._closeBranch = function(my_childrenArray) {
	for (i in my_childrenArray)
	{
		if (isNaN(i) === true) continue; 
		if (my_childrenArray[i] != null) my_childrenArray[i].collapse();
	}
}
